...
<body>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Thank you for purchasing INSPINIA admin theme. If you have any questions about the template, please feel
            free to contact us via email: <a href="mailto:support@webapplayers.com">support@webapplayers.com</a>.<br />
            Thanks very much!</p>
          <small>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="row">
        <div style="float:left;"><b>MyBatis API Example result: </b></div>
        <div id="forMyBatis" style="float: left;"></div>
      </div>
      <div class="row">
        <div style="float:left;"><b>JPA API Example result: </b></div>
        <div id="forJPA"></div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="row">
        <label><b>추이 차트</b></label>
        <div id="drawTransition"></div>
      </div>
      <div class="row">
        <label><b>감성 차트</b></label>
        <div id="drawSentiment"></div>
      </div>
      <div class="row">
        <label><b>원문보기</b></label>
        <div id="drawDocument"></div>
      </div>
    </div>
    ...
    ├── dashboard_4_1.html
        ...
          ...
          <div class="col-md-6">
            ...
            <a target="_blank" href="/resources/images/page.png"><img class="img-responsive"
                src="/resources/images/page.png" alt="page structure"></a>
          </div>
        </div>
        <div class="row">
...
<code>Static_Seed_Project/
  ...
  <!-- AmChart 4 -->
  <script type="text/javascript" src="https://sometrend-res.some.co.kr/common/amchart-4.6.8/core.js"></script>
  <script type="text/javascript" src="https://sometrend-res.some.co.kr/common/amchart-4.6.8/charts.js"></script>
  <script type="text/javascript" src="https://sometrend-res.some.co.kr/common/amchart-4.6.8/plugins/forceDirected.js"></script>
